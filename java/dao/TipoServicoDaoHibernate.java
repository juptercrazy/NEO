...
public class TipoServicoDaoHibernate implements TipoServicoDao {
	...
	public void criarServico(TipoServico servico) throws Exception {
		try {
			...
			throw new Exception("Erro ao criar Tipo de servi�o para a empresa " + servico.getEmpresa().getNome() + e.getMessage(), e);
		}
	}
	...
	public TipoServico buscarPorID(Long id) throws Exception {
		try {
			...
			throw new Exception("Erro ao criar Tipo de servi�o para a empresa " +  e.getMessage(), e);
		}
	}
